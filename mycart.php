...
foreach($_SESSION['cart'] as $key => $value)
{
    ...
    <td>
    <form action='product.php' method='post'><button class='btn btn-sm btn-outline-danger' name='remove'>Remove</button>
  ...
  <button type="submit" class="btn btn-warning"> <a class="dropdown-item" href="product.php">Product</button></a>
</div>
